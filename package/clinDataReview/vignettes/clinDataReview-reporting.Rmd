...
This file should contain input parameters
  containing:
...
Please see the `? clinDataReview-templates` documentation for further information
on the template reports available in the `clinDataReview` package, and their
input parameters.
...
## Creation of the report for production
...
## Creation of the report during development
