...
- plotFunction (optional): string with plot type: 'treemap' and/or 'sunburst' (both by default)
...
if(!exists("plotFunction")) plotFunction <- c("treemap", "sunburst")
...
```{r countsVisualizationTemplate-createTreemap, eval = "treemap" %in% plotFunction}
...
```{r countsVisualizationTemplate-createSunburst, eval = "sunburst" %in% plotFunction}
