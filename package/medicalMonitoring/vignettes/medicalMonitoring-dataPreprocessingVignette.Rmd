---
title: "Data pre-processing for the `medicalMonitoring` package"
...
vignette: >
  %\VignetteIndexEntry{Data pre-processing for the medicalMonitoring package}
...
within the `medicalMonitoring` package.
...
reports (see the
dedicated reporting
[vignette](../doc/medicalMonitoring-reportingVignette.html)).
