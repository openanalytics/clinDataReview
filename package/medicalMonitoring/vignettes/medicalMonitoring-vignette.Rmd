...
available
[here](`r vignette("medicalMonitoring-dataVisualizationVignette", package = "medicalMonitoring")`).
...
[here](`r vignette("medicalMonitoring-reportingVignette", package = "medicalMonitoring")`).
...
# Advanced user: tester/developer
