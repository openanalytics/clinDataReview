...
[here](../doc/medicalMonitoring-reportingVignette.html) or run in your
console the command below.

```{r reportingVignette, eval = FALSE}

vignette("medicalMonitoring-reportingVignette", "medicalMonitoring")
