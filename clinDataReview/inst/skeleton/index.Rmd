...
principles as highlighted in section \@ref(tutorialSubjectLevel). Functionalities 
specific of these visualizations and tables are mentioned in sections \@ref(tutorialSummaryPlots) and
\@ref(tutorialSummaryTables).  
