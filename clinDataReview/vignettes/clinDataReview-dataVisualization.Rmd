...
```{r patientProfilesCreate, results = "hide", eval = hasPandoc & params$patientProfilesCreate}
...
```{r computeSummaryStatistics-categoricalVariable}
...
```{r computeSummaryStatistics-continuousVariable}
...
```{r errorbarClinData, eval = hasPandoc}
