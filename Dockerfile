...
RUN R -e "cat(\"local(options(repos = c(CRAN = 'https://cran.rstudio.com/')))\n\", file = R.home('etc/Rprofile.site'), append = TRUE)"
...
RUN R -q -e "install.packages('remotes')" && \
    ...
    R -q -e "remotes::install_version('countrycode', version = '1.4.0', upgrade = FALSE)"
...
RUN R -q -e "remotes::install_version('fontLiberation', version = '0.1.0', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('fs', version = '1.6.1', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('lazyeval', version = '0.2.2', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('withr', version = '2.5.0', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('diffobj', version = '0.3.5', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('plyr', version = '1.8.8', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('V8', version = '4.2.2', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('crosstalk', version = '1.2.0', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('sass', version = '0.4.5', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('forcats', version = '1.0.0', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('bookdown', version = '0.32', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('htmlwidgets', version = '1.6.1', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('flextable', version = '0.8.5', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('inTextSummaryTable', version = '3.2.1', upgrade = FALSE)" && \
