...
RUN R -q -e "remotes::install_version('xfun', version = '0.43', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('jquerylib', version = '0.1.4', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('urltools', version = '1.7.3', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('purrr', version = '1.0.2', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('shiny', version = '1.8.1.1', upgrade = FALSE)" && \
